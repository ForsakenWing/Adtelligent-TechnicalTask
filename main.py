...
from request_to import post, get, create_session, update_user
...
class UpdatingUserTest(TestCase, Parent):
    ...
    # These tests don`t work because of {'error_code': 30, 'message': 'User not found'}

    # def test_updating(self):
    #
    #     self.assertEqual(self.new_user_data.login, self.new_user.login)
    #
    #     self.assertEqual(self.new_user_data.email, self.new_user.email)
